    ...
    if (!empty($_POST)) {
        ...
        if ($authenticity_token === helper::getAuthenticityToken()) {
            ...
            if (strlen($query) > 2) {
                ...
                $result = $feed_vip->search($query);

            }
        }
    }

    $page_id = "searchFeedsVip";

    helper::newAuthenticityToken();

    $page_title = "Search Feeds  VIP| Admin Panel";
...
?>
    ...
    <body class="sb-nav-fixed" id="page-top">
        ...
        <h1 class="mt-4">Search Feeds VIP</h1>
        <!-- Breadcrumbs-->
        <ol class="breadcrumb">
          <li class="breadcrumb-item">
            <a href="/admin/main">Home</a>
          </li>
          <li class="breadcrumb-item active">Search Feeds VIP</li>
        </ol>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Search Feeds  VIP</h4>

                                    <div class="alert alert-info" role="alert">
                                      Only synchronized Feeds VIP (Firebase -> Mysql) will appear in the result . 
                                ...
                                <form class="form-material m-t-40"  method="post" action="/admin/searchFeedsVip">
                    ...
                    if ($inbox_loaded != 0) {
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Feeds VIP</h4>
